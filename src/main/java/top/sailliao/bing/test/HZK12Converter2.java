...
public class HZK12Converter2 extends JFrame {
    ...
    public HZK12Converter2(String[] text) throws Exception {
        this.text = text;
...
//                "D:\\Git\\Liaozifan\\bing-image\\src\\main\\java\\top\\sailliao\\bing\\test\\input3.bmp",
        ...
        String[] text = "之夜。".split("");

        HZK12Converter2 frame = new HZK12Converter2(text);
