...
@Slf4j
public class HZK12Converter0 {

    public static final String DEFAULT_EMPTY = "";
    ...
    public static String[] splitByWidth(String str, int width) {
        if (StrUtil.isBlank(str) || width <= 0) {
            return new String[0];
        }

        int length = str.length();
        int partCount = (length + width - 1) / width; // 向上取整
    ...
    public static void main(String[] args) throws Exception {
        ...
        String line = getAllInLine(str, width);
        System.out.println(line.length() / 3);


        /*String[] array = splitByWidth(str, 15);
        System.out.println(array.length);
        int start = 0;
        for (String s : array) {
            width = getWidth(s);
            String allInLine = getAllInLine(s, width);
            width = allInLine.length() / 3;
